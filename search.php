      ...
      array_push($songIdArray,$row['id']);
			...
			echo "<li class='tracklistRow'>
					<div class='trackCount'>
						<img class='play' src='assets/images/icons/play-white.png' onlclick='setTrack(\"". $albumSong -> getId() ."\",tempPlaylist,true)'>
          ...
          <input type='hidden' class='songId' value='". $albumSong->getIid() ."'>
